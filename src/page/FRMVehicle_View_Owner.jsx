...
<div className="mt-2 bg-[#151B54] mb-4 text-center text-fuchsia-50 w-full"> FRM Vehicle View Owner </div> 
<div className='flex flex-wrap gap-2 m-auto justify-center py-4'>
   <div  >
     <label   style={{paddingLeft:"10px"}}>Station From </label><br/>
     <select className='px-10 py-1 outline-0 border border-collapse rounded-md'
      ...
      <div  >
       ...
       <input className="px-10 py-1 outline-0 border border-collapse rounded-md" type="text" placeholder="Search by goods_name" value={goods_name} onChange={(e)=>setgoods_name(e.target.value)} />
    ...
    {data?.map((e)=>(<div className="w-full mx-auto bg-white rounded-xl  shadow-2xl border-collapse border overflow-hidden md:max-w-2xl">
      ...
      <p className='bg-blue-900  p-1 text-white text-center font-extrabold'>Enq id: {e.enq_id} </p>
      <div className="p-2">
