...
const RPTVehicleschedulehistotry = () => {
  ...
  const [data, setDate] = useState({
    ...
    reportname: "Vehicle Schedule Histotry",
    date: "4/20/2023",
    date_From: "4/20/2023",
    to: "4/20/2023",
  });
    ...
    setData(
      userData.filter(
        (res) =>
          res.vehicle_no
            .toString()
            .includes(vehicle_schedule_histotry.vehicle_no) &&
          res.booking_date.includes(vehicle_schedule_histotry.sch_date) &&
          res.from.includes(vehicle_schedule_histotry.driver_name.toLowerCase()) &&
          res.from.includes(vehicle_schedule_histotry.from.toLowerCase()) &&
          res.to.includes(vehicle_schedule_histotry.to.toLowerCase())
      )
    );
  }, [
    vehicle_schedule_histotry.vehicle_no,
    vehicle_schedule_histotry.sch_date,
    vehicle_schedule_histotry.driver_name,
    vehicle_schedule_histotry.from,
    vehicle_schedule_histotry.to,
  ]);
  return (
    <div>
      <React.Fragment>
