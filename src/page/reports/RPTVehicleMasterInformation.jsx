                        ...
                        <tbody>
                            {
                                ...
                                <td className="sm:px-3 px-2 sm:text-base text-[8px] border border-slate-300">{uData.vehicle_no}</td>
...
<h1 className="text-end text-xs">Powered by : www.transduniya.com-97553-22022 </h1>
                    ...
                    <button className="btn btn-success bg-[#151B54] py-2 px-2 w-32 text-base mt-10 rounded-lg text-white "onClick={exportPDF}>Download</button> 
...
export default RPTVehicleMasterInformation
